...
const INTEL_LAPTOP: Profile = Profile {
    magic: crate::identity::profile::PROFILE_MAGIC,
    version: crate::identity::profile::PROFILE_VERSION,
    ...
    software: SoftwareProfile {
        os: crate::identity::profile::OsProfile {
            product_name: crate::identity::profile::OsString::from_static("Windows 11 Pro"),
            build_lab: crate::identity::profile::OsString::from_static(""),
            product_id: crate::identity::profile::OsString::from_static(""),
            edition_id: crate::identity::profile::OsString::from_static("Professional"),
            computer_name: crate::identity::profile::OsString::from_static(""),
        },
        registry: crate::identity::profile::RegistryProfile {
            machine_guid: UuidStr::empty(),
            hardware_profile_guid: UuidStr::empty(),
        },
        volume: crate::identity::profile::VolumeProfile { c_drive_serial: ProfileStr::empty() },
        locale: crate::identity::profile::LocaleProfile {
