...
#[inline]
fn profile_id(read: impl FnOnce(*const crate::identity::profile::HardwareProfile) -> u32, fallback: u32) -> u32 {
...
/// reads as no-device.
pub const ECAM_BASE: u64 = crate::acpi::PCIE_MCFG_BASE;
