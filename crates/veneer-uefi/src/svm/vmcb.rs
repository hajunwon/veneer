...
pub unsafe fn init_guest_longmode(vmcb: *mut Vmcb, code_lin: u64) {
    ...
    s.cr0 = crate::arch::read_cr0();
    s.cr3 = crate::arch::read_cr3();
    s.cr4 = crate::arch::read_cr4();
    s.efer = unsafe { crate::arch::rdmsr(crate::arch::MSR_EFER) };
...
pub unsafe fn init_guest_linux(
    ...
    s.rsp = crate::boot::linux_loader::STACK_TOP;
