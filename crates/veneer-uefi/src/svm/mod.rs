...
use crate::arch::{cpuid, rdmsr, wrmsr, EFER_SVME, MSR_EFER, MSR_VM_HSAVE_PA};
...
pub fn bringup() -> Result<SvmState, BringupError> {
    ...
    crate::vmexit::set_cpu_features(nrips, decode_assists);
    ...
    let msrpm_phys = crate::svm::msrpm::alloc_intercept_all()
        .map_err(|_| BringupError::HostSaveAllocFailed)?;
    let iopm_phys = crate::svm::iopm::alloc_intercept_all()
        .map_err(|_| BringupError::HostSaveAllocFailed)?;
