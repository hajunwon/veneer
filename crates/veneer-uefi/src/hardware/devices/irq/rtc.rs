...
fn read_indexed(idx: u8) -> u8 {
    ...
    match idx & 0x7F {
        ...
        0x5B => ((crate::guest::boot::guest_mem::high_size() >> 16) & 0xFF) as u8,
        0x5C => ((crate::guest::boot::guest_mem::high_size() >> 24) & 0xFF) as u8,
        0x5D => ((crate::guest::boot::guest_mem::high_size() >> 32) & 0xFF) as u8,
        _    => 0,
    }
}
...
fn mem_ext_64k_units() -> u16 {
    ...
    let low_ram = crate::guest::boot::linux_loader::GUEST_RAM_BYTES;
