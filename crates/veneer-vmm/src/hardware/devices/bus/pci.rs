...
#[inline]
fn profile_id(read: impl FnOnce(*const crate::hardware::identity::profile::HardwareModel) -> u32, fallback: u32) -> u32 {
...
fn pid_host_bridge() -> u32 { profile_id(|h| unsafe { core::ptr::addr_of!((*h).board.spec.host_bridge_id).read_unaligned() }, 0x29C0_8086) }
fn pid_nic() -> u32   { profile_id(|h| unsafe { core::ptr::addr_of!((*h).network.spec.pci_id).read_unaligned() }, 0x15F3_8086) }
fn pid_nvme() -> u32  { profile_id(|h| unsafe { core::ptr::addr_of!((*h).storage.spec.pci_id).read_unaligned() }, 0xA80A_144D) }
fn pid_lpc() -> u32   { profile_id(|h| unsafe { core::ptr::addr_of!((*h).board.spec.lpc_id).read_unaligned() }, 0x790E_1022) }
fn pid_sata() -> u32  { profile_id(|h| unsafe { core::ptr::addr_of!((*h).board.spec.sata_id).read_unaligned() }, 0x7901_1022) }
fn pid_smbus() -> u32 { profile_id(|h| unsafe { core::ptr::addr_of!((*h).board.spec.smbus_id).read_unaligned() }, 0x790B_1022) }
fn pid_hda() -> u32   { profile_id(|h| unsafe { core::ptr::addr_of!((*h).audio.spec.pci_id).read_unaligned() }, 0x1457_1022) }
fn pid_xhci() -> u32  { profile_id(|h| unsafe { core::ptr::addr_of!((*h).board.spec.xhci_id).read_unaligned() }, 0x149C_1022) }
fn pid_gpu() -> u32   { profile_id(|h| unsafe { core::ptr::addr_of!((*h).gpu.spec.pci_id).read_unaligned() }, 0x164E_1002) }
